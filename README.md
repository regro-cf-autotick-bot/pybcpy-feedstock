...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pybcpy-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14264&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pybcpy-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pybcpy` can be installed with:

```
conda install pybcpy
```

It is possible to list all of the versions of `pybcpy` available on your platform with:
